...
app_include_js = [
    ...
    "/assets/avinashgroup_app/js/purchase_taxes_common.js?v=3.1",
    # Buying VAT / TDS / excise and header-discount shares cut (not rounded) to
    # 2 dp in the form preview; server half is custom_code/common/purchase_paisa_truncation.py.
    "/assets/avinashgroup_app/js/purchase_paisa_truncation.js?v=1.0",
    ...
    "/assets/avinashgroup_app/js/global_filter.js?v=1.9",
    ...
    "/assets/avinashgroup_app/js/ngi_print.js?v=1.6",
