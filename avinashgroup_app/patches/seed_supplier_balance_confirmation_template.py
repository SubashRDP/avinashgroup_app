...
TEMPLATE_NAME = "Supplier Balance Confirmation Letter"
...
sending you the following information regarding our purchases and balance of accounts
...
FIELD_TABLE = [
	...
	{"label": "Purchase (Excl. VAT)", "value_expr": "fmt(data.period_credit)"},
	{"label": "VAT Amount", "value_expr": "fmt(data.vat_amount)"},
	{"label": "Payments Made", "value_expr": "fmt(data.period_debit)"},
...
<td style="width:50%;text-align:right">______________________<br>Confirmed by, {{ data.party_name }}</td>
</tr></table>
"""


def execute():
	"""Seed a ready-to-use Supplier Balance Confirmation Letter template (idempotent)."""
